...
{
    /// <summary>
    /// Contains data and information for the Segoe UI Symbol icons.
    /// </summary>
    public class SegoeUISymbol : IconSetBase
    {
        ...
        /// <summary>
        /// Gets a read-only list of all icons in the Segoe UI Symbol icon set.
        /// </summary>
